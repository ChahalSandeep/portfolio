...
const projectData = {
    ...
    'llm-retrieval': {
        ...
        features: [
            ...
            "    <div class='diagram-component user'>User Query (NQL)</div>",
            "  </div>",
            "  <div class='diagram-arrow'>↓</div>",
            "  <div class='diagram-row'>",
            "    <div class='diagram-component llm'>LLM Backbone<br><small>SQLCoder (LLAMA)</small></div>",
            "  </div>",
            "  <div class='diagram-arrow'>↓</div>",
            "  <div class='diagram-row'>",
            "    <div class='diagram-component agent snowflake'>Snowflake Query Agent<br><small>NQL → SQL → Snowflake → JSON/Table</small></div>",
            "    <div class='diagram-component agent confluence'>Confluence Search Agent<br><small>NQL → FAISS → LLM Summary</small></div>",
            "  </div>",
            "  <div class='diagram-arrow'>↓</div>",
            "  <div class='diagram-row'>",
            ...
            "  <div class='diagram-arrow'>↓</div>",
            "  <div class='diagram-row'>",
            "    <div class='diagram-component frontend'>Frontend<br><small>Streamlit UI</small></div>",
            "  </div>",
            "</div>",
            "",
            "<span class='section-header'>Impact:</span>",
